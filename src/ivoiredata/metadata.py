...
# Deterministic, conservative rules. They are intentionally simple and auditable;
# an ML/LLM classifier is not required for the normal path.
_DOMAIN_KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    "agriculture": ("agric", "cacao", "café", "cafe", "anacarde", "hévéa", "hevea", "élevage", "elevage", "vivrier"),
    "food_security": ("sécurité alimentaire", "securite alimentaire", "insécurité alimentaire", "insecurite alimentaire", "nutrition"),
    "economy": ("économie", "economie", "pib", "croissance", "commerce", "import", "export", "entreprise", "investissement"),
    "public_finance": ("budget", "loi de finances", "dépense publique", "depense publique", "recette publique", "dgbf"),
    "taxation": ("impôt", "impot", "fiscal", "tva", "taxe", "fne", "dgi"),
    "labor": ("emploi", "travail", "chômage", "chomage", "salaire", "main-d'œuvre", "main d'oeuvre"),
    "social_protection": ("cnps", "protection sociale", "retraite", "allocation", "cotisation sociale"),
    ...
    "environment_climate": ("environnement", "climat", "météo", "meteo", "pluie", "émission", "emission", "biodiversité", "foret", "forêt"),
    "extractives_energy": ("mine", "minier", "pétrole", "petrole", "gaz", "énergie", "energie", "électricité", "electricite"),
    ...
    "transport": ("transport", "mobilité", "mobilite", "véhicule", "vehicule", "aéroport", "aeroport", "portuaire"),
    "roads": ("route", "routier", "chaussée", "chaussee", "ageroute", "pont", "échangeur", "echangeur"),
    "telecom": ("télécom", "telecom", "internet", "téléphonie", "telephonie", "artci", "numérique", "numerique"),
